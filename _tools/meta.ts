...
export const makeOptions = (version: string): BuildOptions => ({
  ...
  package: {
    ...
    version,
    description: "Headers utility collection",
    keywords: [
      "http",
      "headers",
      "header",
    ...
    license: "MIT",
    homepage: "https://github.com/httpland/headers-utils",
    repository: {
      type: "git",
      url: "git+https://github.com/httpland/headers-utils.git",
    },
    bugs: {
      url: "https://github.com/httpland/headers-utils/issues",
    },
    main: undefined,
    module: undefined,
    types: undefined,
